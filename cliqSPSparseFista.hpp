#ifndef CLIQSPSPARSEFISTA_HPP
#define CLIQSPSPARSEFISTA_HPP
...
int cliqSPSparseFista(const subProblem *subProb, const double tau, double &energy, std::vector<double> &nodeMarg)
{
 std::vector<int> subProbNodeOffset = subProb->getNodeOffset();
 std::vector<double> subProbDualVar = subProb->getMomentum();
...
int performSPFwdSparse(const subProblem *subProb, const std::vector<int> &subProbNodeOffset, const std::vector<double> &subProbDualVar, const double tau, const std::vector<double> &bwdMargVec, const std::vector<double> &expoMaxBwd, double &energy, std::vector<double> &nodeMarg)
{
 energy = 0;
